...
function dart_precompiled($collectedClasses) {
  ...
  function processStream_closure(box_0, fromStream_1, responseStream_2) {
    this.box_0 = box_0;
    this.fromStream_1 = fromStream_1;
    this.responseStream_2 = responseStream_2;
  }
  processStream_closure.builtin$cls = "processStream_closure";
  if (!"name" in processStream_closure)
    processStream_closure.name = "processStream_closure";
  $desc = $collectedClasses.processStream_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  processStream_closure.prototype = $desc;
  function processStream__closure(response_3) {
    this.response_3 = response_3;
  }
  processStream__closure.builtin$cls = "processStream__closure";
  if (!"name" in processStream__closure)
    processStream__closure.name = "processStream__closure";
  $desc = $collectedClasses.processStream__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  processStream__closure.prototype = $desc;
  function processStream_closure0(responseStream_4) {
    this.responseStream_4 = responseStream_4;
  }
  processStream_closure0.builtin$cls = "processStream_closure0";
  if (!"name" in processStream_closure0)
    processStream_closure0.name = "processStream_closure0";
  $desc = $collectedClasses.processStream_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  processStream_closure0.prototype = $desc;
  function main_output(tae_0) {
    this.tae_0 = tae_0;
  }
  main_output.builtin$cls = "main_output";
  if (!"name" in main_output)
    main_output.name = "main_output";
  $desc = $collectedClasses.main_output;
  if ($desc instanceof Array)
    $desc = $desc[1];
  main_output.prototype = $desc;
  function main_closure(sc_1, output_2, spawnIsolate_3) {
    this.sc_1 = sc_1;
    this.output_2 = output_2;
    this.spawnIsolate_3 = spawnIsolate_3;
  }
  ...
  function main__closure(output_4) {
  ...
  function main_closure0(sc_5, output_6, numeric_7) {
    this.sc_5 = sc_5;
    this.output_6 = output_6;
    this.numeric_7 = numeric_7;
  }
  ...
  function main__closure0(output_8) {
    this.output_8 = output_8;
  }

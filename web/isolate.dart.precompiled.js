...
["", "isolate.dart", , O, {
  "": "",
  main: [function(args, mainThread) {
    var t1, receivePort;
    t1 = J.getInterceptor(mainThread);
    if (typeof mainThread === "object" && mainThread !== null && !!t1.$isSendPort) {
      receivePort = P.ReceivePort_ReceivePort();
      mainThread.send$1(new H._NativeJsSendPort(receivePort._rawPort, init.globalState.currentContext.id));
      t1 = receivePort._controller;
      t1.toString;
      H.setRuntimeTypeInfo(new P._ControllerStream(t1), [null]).listen$4$cancelOnError$onDone$onError(new O.main_closure(mainThread), null, null, null);
    } else
      throw H.wrapException(P.Exception_Exception("Expected value to be a 'SendPort'"));
  }, "call$2", "main$closure", 4, 0, 8],
  main_closure: {
    "": "Closure:11;mainThread_0",
    call$1: function(data) {
      if (typeof data === "number" && Math.floor(data) === data)
        this.mainThread_0.send$1(data + 1);
    }
  }
},
1],
...
function dart_precompiled($collectedClasses) {
  ...
  function main_closure(mainThread_0) {
    this.mainThread_0 = mainThread_0;
  }
